 ...
 *
 *=========================================================================*/
#ifndef __itkWindowedMinimumImageFilter_hxx
#define __itkWindowedMinimumImageFilter_hxx
...
WindowedMinimumImageFilter< TInputImage, TOutputImage >
                       ...
                       ThreadIdType threadId)
{
  ...
  for ( typename NeighborhoodAlgorithm::ImageBoundaryFacesCalculator< InputImageType >::FaceListType::iterator
    ...
    while ( !bit.IsAtEnd() )
      ...
      const typename std::vector< InputPixelType >::iterator medianIterator = std::min_element( pixels.begin(), pixels.end() );
