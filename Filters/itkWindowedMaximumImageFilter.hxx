 ...
 *
 *=========================================================================*/
#ifndef __itkWindowedMaximumImageFilter_hxx
#define __itkWindowedMaximumImageFilter_hxx
...
WindowedMaximumImageFilter< TInputImage, TOutputImage >
                       ...
                       ThreadIdType threadId)
{
  ...
  for ( typename NeighborhoodAlgorithm::ImageBoundaryFacesCalculator< InputImageType >::FaceListType::iterator
    ...
    while ( !bit.IsAtEnd() )
      ...
      const typename std::vector< InputPixelType >::iterator medianIterator = std::max_element( pixels.begin(), pixels.end() );
